...
public class LicenseInfoHandler implements LicenseInfoService.Iface {
    ...
    private static String loadDefaultLicenseInfoHeaderText(){
        try {
            String defaultLicenseInfoHeader = IOUtils.toString(LicenseInfoHandler.class.getResourceAsStream(DEFAULT_LICENSE_INFO_HEADER_FILE), "UTF-8");
            ...
            LOGGER.error("Could not read default license info header text from file.");
            return "";
        }
    }
}
