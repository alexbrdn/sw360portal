...
define('modules/sw360Wizard', [ 'jquery' ], function($) {
     ...
     *         <ul>
     *             <li class="backgroundOK">Step Name<br /><small>This can be a short description</small></li>
     *             <li>Another Step Name<br /><small>Another description</small></li>
     *         </ul>
     *     </div>
        ...
        function changeHeaderState(lastActiveIndex, activeIndex) {
            $('.wizardHeader li', $wizardRoot).each(function(index, element) {
                if (index === lastActiveIndex) {
                    $(element).removeClass('backgroundOK');
                }
                if (index === activeIndex) {
                    $(element).addClass('backgroundOK');
                }
            });
        }
